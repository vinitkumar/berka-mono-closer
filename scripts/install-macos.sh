...
existing_fonts=$(find "$font_dir" -maxdepth 1 -type f \( -name "BerkaMonoCloser*.ttf" -o -name "BerkaMonoCloserCompact*.ttf" -o -name "BerkaMonoCloserSemiCondensed*.ttf" -o -name "BerkaMonoCloserNarrow*.ttf" -o -name "BerkaMonoControl*.ttf" -o -name "BerkaMonoRetina*.ttf" -o -name "BerkaMonoFocus*.ttf" -o -name "BerkaText*.ttf" \) -print)
...
copy_fonts "Berka Text" "$repo_dir/fonts/ttf-text" "BerkaText*.ttf"

set_step "Installed Berka Mono Closer, Berka Mono Closer Compact, Berka Mono Closer SemiCondensed, Berka Mono Closer Narrow, Berka Mono Control, Berka Mono Retina, Berka Mono Focus, and Berka Text into $font_dir"
